export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'mysupergains',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'My Super Gains',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'mysupergains.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://mysupergains.com',
